...
class Asteroid(CircleShape):
    ...
    def split(self):
        ...
        new_asteroid_1 = Asteroid(self.position.x, self.position.y, small_asteroid_radius)
        new_asteroid_2 = Asteroid(self.position.x, self.position.y, small_asteroid_radius)
